...
int serial_open(const char * path, const char * protocol) {return -1;}
int serial_send(int fd, const char * buffer, size_t size) {return -1;}
int serial_recv(int fd, char * buffer, size_t max_size, int ms) {return -1;}
int serial_flush(int fd, int input, int output) {return -1;}
int serial_drain(int fd) {return -1;}
int serial_has_buffer(int fd, int io) {return -1;}
int serial_close(int fd) {return -1;}
